    ...
    tasks: [
      {
        ...
        type: "shell",
        command: "epicchain",
        args: ["create", "-f", "test/$_CONTRACTNAME_$Tests.epicchain-express"],
        problemMatcher: [],
      },
      {
        ...
        type: "shell",
        command: "epicchain",
        args: ["wallet", "create", "-i", "test/$_CONTRACTNAME_$Tests.epicchain-express", "owner"],
        problemMatcher: [],
      },
      {
        ...
        type: "shell",
        command: "epicchain",
        args: ["wallet", "create", "-i", "test/$_CONTRACTNAME_$Tests.epicchain-express", "alice"],
        problemMatcher: [],
      },
      {
        ...
        type: "shell",
        command: "epicchain",
        args: ["wallet", "create", "-i", "test/$_CONTRACTNAME_$Tests.epicchain-express", "bob"],
        problemMatcher: [],
      },
      {
        ...
        type: "shell",
        command: "epicchain",
        args: ["batch", "-i", "$_CONTRACTNAME_$Tests.epicchain-express", "test/setup-test-chain.batch"],
        problemMatcher: [],
      },
      {
        label: "build",
