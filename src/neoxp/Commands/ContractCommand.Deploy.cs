...
//
// ContractCommand.Deploy.cs file belongs toepicchain-express project and is free
...
namespace NeoExpress.Commands
{
    ...
    {
        [Command("deploy", Description = "Deploy contract to aepicchain-express instance")]
