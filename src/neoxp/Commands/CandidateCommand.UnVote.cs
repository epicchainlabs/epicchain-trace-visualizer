...
//
// CandidateCommand.UnVote.cs file belongs toepicchain-express project and is free
...
namespace NeoExpress.Commands
{
    partial class CandidateCommand
    {
        ...
        internal class UnVote
        {
            ...
            public UnVote(ExpressChainManagerFactory chainManagerFactory, TransactionExecutorFactory txExecutorFactory)
            {
