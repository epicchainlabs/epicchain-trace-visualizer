...
//
// CheckpointCommand.Run.cs file belongs toepicchain-express project and is free
...
namespace NeoExpress.Commands
{
    ...
    {
        [Command("run", Description = "Run aepicchain-express checkpoint (discarding changes on shutdown)")]
        internal class Run
        {
