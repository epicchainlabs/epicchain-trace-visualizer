...
> Note, all `checkpoint` subcommands require a single-node EpicChain-Express blockchain.
...
> Note, unlike EpicChain MainNet and TestNet, EpicChain-Express does not automatically fulfill oracle requests
